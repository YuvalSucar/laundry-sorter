...
![System Photo](assets/system_photo.jpg)
...
| Challenge | Solution |
|-----------|----------|
| Raspberry Pi thermal throttling under ML load | Active cooling + optimized inference loop |
| Motor power spikes causing resets | Dedicated 5V/8A supply for driver and servos |
